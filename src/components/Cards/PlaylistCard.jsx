  ...
  return (
    <div className={`cursor-pointer transition ${
      ...
      <div className={`group relative overflow-hidden rounded-xl aspect-square ${
        ...
        <button className="absolute inset-0 m-auto w-12 h-12 bg-[#FF6B6B] rounded-full shadow-lg transition flex items-center justify-center opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transform duration-200">
